...
int OrkSpear::getSpriteNumberInSpritesArray()
{
	return spriteNumberInSpritesArray;
}

void OrkSpear::setSpriteNumberInSpritesArray(int num)
{
...
void OrkSpear::animationForOpponentMoving(int animation, sf::RenderWindow * tempWindow, Render * tempRender, Player *player)
{
	if (animation == FIGHT)
	{
