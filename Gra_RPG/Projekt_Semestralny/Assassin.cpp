...
int Assassin::getSpriteNumberInSpritesArray()
{
	return spriteNumberInSpritesArray;
}

void Assassin::setSpriteNumberInSpritesArray(int num)
{
...
void Assassin::animationForOpponentMoving(int animation, sf::RenderWindow *tempWindow, Render* tempRender, Player *player)
{
	if (animation == FIGHT)
	{
