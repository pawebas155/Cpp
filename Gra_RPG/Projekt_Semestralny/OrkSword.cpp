...
int OrkSword::getSpriteNumberInSpritesArray()
{
	return spriteNumberInSpritesArray;
}

void OrkSword::setSpriteNumberInSpritesArray(int num)
{
...
void OrkSword::animationForOpponentMoving(int animation, sf::RenderWindow * tempWindow, Render * tempRender, Player *player)
{
	if (animation == FIGHT)
	{
